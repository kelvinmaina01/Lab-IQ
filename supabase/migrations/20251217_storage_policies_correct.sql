...
-- Uses team_members join for channel_members
-- Date: 2025-12-17
-- ============================================
...
-- ============================================
-- COLLABORATION-FILES BUCKET (FIXED)
-- ============================================
...
-- ============================================
-- AVATARS BUCKET (No changes needed)
-- ============================================
...
-- ============================================
-- PROJECT-ATTACHMENTS BUCKET (No changes needed)
-- ============================================
...
BEGIN
  ...
  RAISE NOTICE '========================================';
  RAISE NOTICE '✓ collaboration-files policies updated';
  RAISE NOTICE '✓ avatars policies applied';
  RAISE NOTICE '✓ project-attachments policies applied';
  RAISE NOTICE '';
  RAISE NOTICE '🎉 All policies use correct schema!';
  RAISE NOTICE '========================================';
END $$;
